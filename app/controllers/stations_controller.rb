class StationsController < ApplicationController
  ...
  private
    ...
    def station_params
      params.expect(station: [ :registration_number, :latitude, :longitude, :municipality, :station_type_id, :last_name, :first_name, :company_name, :email, :telephone, :mmsi_id, :user_id, documents: [] ])
    end
end
